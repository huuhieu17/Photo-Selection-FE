...
const SignUp = () => {
  ...
  const validate = () => {
    ...
    if (emailInput === '') {
      _errors.email = 'Không được để trống';
    ...
    if (nameInput === '') {
      _errors.name = 'Không được để trống';
    } else {
      delete _errors.name;
    }
    if (passwordInput === '') {
      _errors.password = 'Không được để trống';
    } else {
      delete _errors.password;
    }
    if (rePasswordInput === '') {
      _errors.rePasswordInput = 'Không được để trống';
    } else if (rePasswordInput != passwordInput) {
      _errors.rePasswordInput = 'Mật khẩu không khớp';
    } else {
      delete _errors.rePasswordInput;
    }
    setErrors(_errors);
  ...
  const handleSignUp = async () => {
    ...
    if(valid) {
      try {
        const res = await register(nameInput, emailInput, passwordInput);
      if(res.status === 200) {
        ...
        toast.error(response.data ? response.data?.message : 'Có lỗi xảy ra')
      }
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <div className="text-4xl">Steve Photo</div>
              </Link>
              <p className="2xl:px-20">
                Chào mừng bạn đến với hệ thống của tôi, chúc bạn 1 ngày tốt lành
              </p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                <div className="mb-4">
                  ...
                  {errors && errors.name && <small className='text-red-500'>{errors.name}</small>}
                </div>
                ...
                <div className="mb-4">
                  ...
                  {errors && errors.email && <small className='text-red-500'>{errors.email}</small>}
                </div>
                ...
                <div className="mb-4">
                  ...
                  {errors && errors.password && <small className='text-red-500'>{errors.password}</small>}
                </div>
                ...
                <div className="mb-6">
                  ...
                  {errors && errors.rePasswordInput && <small className='text-red-500'>{errors.rePasswordInput}</small>}
                </div>
